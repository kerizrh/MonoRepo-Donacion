...
public class DonacionController {
    ...
    public ResponseEntity<?> donar(@RequestBody Map<String, Object> payload,
        ...
        try {
            ...
            Integer puntosActualizados = donacionService.obtenerPuntos(usuarioId);

            return ResponseEntity.ok(Map.of("mensaje", "Donación realizada con éxito", "puntos", puntosActualizados));
        } catch (Exception e) {
